...
import com.example.patrick.proj_motorista.Entidades.LocationData;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(viagem.getSituacaoEmAndamento().equals("EsperandoCarregamento")){
            ControleDeCoordenadas = viagem.getLocalCarregamento();
            System.out.println("Desisto " + viagem.getLocalCarregamento());
            }
            else{
                if(viagem.getSituacaoEmAndamento().equals("EsperandoDescarregamento")){
                    ControleDeCoordenadas = viagem.getLocalDescarga();
                }
                else{
                    if(viagem.getSituacaoEmAndamento().equals("EsperandoFinalizacao")){
                        ControleDeCoordenadas = "Frutivilla, Fraiburgo+Brasil";
                }
            }
        }
        ...
        //Uri gmmIntentUri = Uri.parse("google.navigation:q=Parque+da+Maçã,+Fraiburgo+Brasil");
        Uri gmmIntentUri = Uri.parse("google.navigation:q=" + ControleDeCoordenadas);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        CameraPosition cameraPosition = new CameraPosition.Builder().zoom(15).target(fraiburgo).build();
    ...
    public void onLocationChanged(Location location) {
        ...
        System.out.println("teste 2"+ location.getLatitude() + location.getLongitude());
